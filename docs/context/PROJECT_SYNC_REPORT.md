...
> **Aggiornato:** 2026-06-29 · branch `document-center` · HEAD `efe5e03`.
...
## 3. Stato attuale
- **Branch/HEAD:** `document-center` == `main` == `efe5e03` (nessuna divergenza, ✅ git).
- **In `main`:** Front Office (concierge + booking/preventivi Tier-1/Tier-2), Document Center MVP (codice), Fail-Fast DB, doc v1.0 + architettura a strati.
